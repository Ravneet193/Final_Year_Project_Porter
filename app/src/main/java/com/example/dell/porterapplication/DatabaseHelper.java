...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String Central_longitude = "Central_longitude";
    public static final String Central_lattitude = "Central_lattitude";
    ...
    public static final String Bp_Service = "Bp_Service";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        SQL_String = "CREATE TABLE IF NOT EXISTS "+ Station_Table + " ( " +
                ...
                Station_Name+ " TEXT, "+
                Central_lattitude+ " TEXT, "+
                Central_longitude+ " TEXT "+
                " ) ";
        db.execSQL(SQL_String);
        ...
        values.put(this.User_Password,"123456");
        values.put(this.User_First_Name,"Ravneet");
        values.put(this.User_Last_Name,"Taneja");
        values.put(this.User_Phone_No,"8861186155");
        long id = db.insert(this.User_Table,null,values);
        if(id == -1)
        {
            Log.e("hi","something went wrong");
        }

        values = new ContentValues();
        values.put(this.Station_Name,"Karnal");
        values.put(this.Central_lattitude, "29.6856929");
        values.put(this.Central_longitude,"76.99048249999998");
        id = db.insert(this.Station_Table,null,values);
        if(id == -1)
        {
            Log.e("hi","something went wrong");
        }
        ...
        values = new ContentValues();
        values.put(this.Station_Name,"Panipat");
        values.put(this.Central_lattitude, "29.3909464");
        values.put(this.Central_longitude,"76.96350230000007");
        id = db.insert(this.Station_Table,null,values);


        values = new ContentValues();
        values.put(this.Train_Name,"Shatabdi");
        values.put(this.No_Of_Coach, "50");
        id = db.insert(this.Train_Table,null,values);
        if(id == -1)
        {
            Log.e("hi","something went wrong");
        }
        ...
        values = new ContentValues();
        values.put(this.Route_Train_Id,"1");
        values.put(this.Departure_Station_Id,"1");
        values.put(this.Arrival_Station_Id,"2");
        values.put(this.Arrival_Time,"10:35 am");
        values.put(this.Departure_Time,"9:00 am");
        id = db.insert(this.Train_Route_Table,null,values);
        if(id == -1)
        {
            Log.e("hi","something went wrong");
        }
        ...
        String val1 = String.valueOf(new GregorianCalendar(2018,04,8).getTimeInMillis());
        String val2 = String.valueOf(new GregorianCalendar(2018, 04, 10).getTimeInMillis());
        String val3 = String.valueOf(new GregorianCalendar(2018, 04, 10).getTimeInMillis());
        values = new ContentValues();
        values.put(this.Pnr,"10X0PNR1123");
        values.put(this.Bt_User_Id,"1");
        values.put(this.Bt_Route_Id,"1");
        values.put(this.Coach_No,"11");
        values.put(this.Seat_No,"3A");
        values.put(this.Booking_Date,val1);
        values.put(this.Arrival_Date,val2);
        values.put(this.Destination_Date,val3);
        id = db.insert(this.Booking_Train_Table,null,values);
        if(id == -1)
        {
            Log.e("hi","something went wrong");
        }
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "PorterDb.db";
    ...
    public static final String Payment_Table = "PaymentActivity";
    public static final String Payment_Id = "Payment_Id";
    public static final String Payment_Type= "Payment_Type";
    public static final String Discount_Percentage = "Discount_Percentage";
    public static final String Amount = "Amount";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        long val1 = new GregorianCalendar(2018,04,8).getTimeInMillis();
        long val2 = new GregorianCalendar(2018, 04, 10).getTimeInMillis();
        long val3 = new GregorianCalendar(2018, 04, 10).getTimeInMillis();
        values = new ContentValues();
        values.put(this.Pnr,"10X0PNR1123");
        values.put(this.Bt_User_Id,1);
        values.put(this.Bt_Route_Id,1);
