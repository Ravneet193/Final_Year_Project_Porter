...
public class RegisteringActivity extends AppCompatActivity {
    ...
    private String first_name,last_name, email, password, phoneno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                phoneno = PhoneNumber.getText().toString().trim();

                if(first_name.isEmpty() || last_name.isEmpty() || email.isEmpty() || password.isEmpty() || phoneno.isEmpty())
                {
    ...
    public void populateDatabase()
    {
        ...
        values.put(DatabaseHelper.User_Phone_No,phoneno);
